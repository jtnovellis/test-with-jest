...
describe('should to change position', () => {
    ...
    it('should to return an error', () => {
        const objCreateRobot = createRobot(11, 3);
        expect(objCreateRobot.advance()).toMatch(/invalid movement/)
        expect(objCreateRobot.movement('D')).toMatch(/invalid movement/)
    });
});